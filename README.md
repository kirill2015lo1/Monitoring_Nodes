...
И уже далее в prometheus указать ip наших серверов с proxmox, куда он будет ходить забирать метрики. Локи настраивать не надо, так как он только принимает логи, которые высылаются из promtail
